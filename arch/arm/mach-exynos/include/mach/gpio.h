...
extern void gpio_cfg_pin(int gpio, int cfg);
extern void gpio_set_pull(int gpio, int mode);
extern void gpio_set_drv(int gpio, int mode);
extern void gpio_set_rate(int gpio, int mode);
extern int s5p_gpio_get_pin(unsigned gpio);
#endif
