...
#define ASYNC_CONFIG_ADR		(*(volatile unsigned int *)0x10010350)
#define TEST1_ADR				(*(volatile unsigned int *)0x10040500)
#define TEST2_ADR				(*(volatile unsigned int *)0x10020A00)
#define TEST3_ADR				(*(volatile unsigned int *)0x10040A00)
